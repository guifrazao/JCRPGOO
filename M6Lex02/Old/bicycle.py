from validator import Validator_Bicycle, invalidDataMessage
...
class Bicycle:
    def __init__(self, velocidade, cadencia, marcha, nmr_serie, owner: Owner):
        ...
        self.__owner = owner
        self.__owner.set_bicycle(self)  # Associação bilateral: Bicycle -> Owner
    ...
    def setOwner(self, owner: Owner):
        self.__owner = owner
        owner.set_bicycle(self)  # Associação bilateral: Owner -> Bicycle
