...
from estudantes import Graduacao, Mestrado, Doutorado, EnsinoMedio
    ...
    def menuAdicionarEstudante(self):
        ...
        while escolha:
            ...
            if escolha == 1:
                ...
                system('cls')
                nome, matricula, idade = Menu.coletarDadosEstudantes()
                titulo_projeto = input("Informe o título do projeto: ")
                self.gestaoAcademica.adicionarEstudante(Mestrado(nome, matricula, idade, titulo_projeto, numero_notas=3))
            
            else:
                system('cls')
                nome, matricula, idade = Menu.coletarDadosEstudantes()
                titulo_projeto = input("Informe o título do projeto: ")
                self.gestaoAcademica.adicionarEstudante(Doutorado(nome, matricula, idade, titulo_projeto, numero_notas=3))
