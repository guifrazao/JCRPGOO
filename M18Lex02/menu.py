    ...
    def menuAdicionarAnimal(self):
        ...
        while escolha:
            ...
            if escolha == 1:
                ...
                orgao_respiratorio = input("Orgão respiratório: ")
                anfibio = Anfibio(nome, cor, orgao_respiratorio)
                ...
                orgao_respiratorio = input("Orgão respiratório: ")
                reptil = Reptil(nome, cor, orgao_respiratorio)
                ...
                orgao_respiratorio = input("Orgão respiratório: ")
                ave = Ave(nome, cor, envergadura, orgao_respiratorio) if input("Esta ave nada? [s/n]: ").lower() == "n" else AveAquatica(nome, cor, envergadura, orgao_respiratorio)
                ...
                if input("Este mamífero voa? [s/n]: ").lower() == "s":
                    envergadura = int(input("Envergadura(cm) do mamífero: "))
                    mamifero = MamiferoVoador(nome, cor, envergadura, orgao_respiratorio)
                else:
                    mamifero = Mamifero(nome, cor, orgao_respiratorio)
